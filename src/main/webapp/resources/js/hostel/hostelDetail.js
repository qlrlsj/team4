    ...
    $.ajax({
     ...
     //       console.log("옵션리스트 호출");
            ...
            for(let i=0; i<data.length;i++){
                ...
                const div31 = $("<div class='option-range'>"+data[i].roomName+"/"+data[i].roomOption+"</div>");
                const div32 = $("<div class='option-price'>가격:"+data[i].hostelPrice+"원</div></div>");
                
                const reBtn = $("<div class='option-btn'><button type='button' name='reserveBtn' class='reserveBtn btn btn-outline-secondary' >예약하기</button><button type='submit'  id='submitBtn'>제출</button></div>");
