		...
		<form action="/updateMember.kt" method="post">
			<div class="mb-3">
				...
				<input type="text" name="memberNo" class="form-control"
					id="formGroupExampleInput" value="${sessionScope.m.memberNo }" readonly>
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput" class="form-label">아이디</label>
				<input type="text" name="memberId" class="form-control"
					id="formGroupExampleInput" value="${sessionScope.m.memberId }" readonly>
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput" class="form-label">비밀번호</label>
				<input type="password" name="memberPw" class="form-control"
					id="formGroupExampleInput" value="${sessionScope.m.memberPw }">
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput" class="form-label">이름</label>
				<input type="text" name="memberName" class="form-control"
					id="formGroupExampleInput" value="${sessionScope.m.memberName }">
			</div>
			<div class="mb-3">
				<c:choose>
					<c:when test="${sessionScope.m.memberGrade eq '0'}">
						<label for="formGroupExampleInput" class="form-label">회원등급</label>
						<input type="text"  class="form-control"
							id="formGroupExampleInput" placeholder="Example input placeholder" value="관리자" disabled>
							<input type="hidden" name="memberGrade" value="0">
					</c:when>
					<c:when test="${sessionScope.m.memberGrade eq '1'}">
						<label for="formGroupExampleInput" class="form-label">회원등급</label>
						<input type="text" class="form-control"
							id="formGroupExampleInput" placeholder="Example input placeholder" value="판매자" disabled>
							<input type="hidden" name="memberGrade" value="1">
					</c:when>
					<c:when test="${sessionScope.m.memberGrade eq '2'}">
						<label for="formGroupExampleInput" class="form-label">회원등급</label>
						<input type="text" class="form-control"
							id="formGroupExampleInput" placeholder="Example input placeholder" value="구매자" disabled>
							<input type="hidden" name="memberGrade" value="2">
					</c:when>
				</c:choose>
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput" class="form-label">전화번호</label> <input
			...
			<div class="mb-3">
				<label for="formGroupExampleInput" class="form-label">이메일</label> <input
					type="text" name="memberEmail" class="form-control"
					id="formGroupExampleInput" value="${sessionScope.m.memberEmail }">
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput" class="form-label">자기소개</label> <input
					type="text" name="memberIntro" class="form-control"
