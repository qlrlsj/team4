...
<body>
	...
	<div class="sellerWrap">
		...
		<div class="div-content">
			<div class="mb-3">
				<div class="content-title">상품 조회</div>
			</div>
			<form action="/sellerProduct.kt" method="post">
				<input type="hidden" name="type" value="hostel">
				<input type="hidden" name="memberNo" value="${sessionScope.m.memberNo }">
				<input type="hidden" name="memberId" value="${sessionScope.m.memberId }">
				<button class="btn btn-primary sell" type="submit" >호스텔 상품 조회</button>
			</form>
			<form action="/sellerProduct.kt" method="post">
				<input type="hidden" name="type" value="ticket">
				<input type="hidden" name="memberNo" value="${sessionScope.m.memberNo }">
				<input type="hidden" name="memberId" value="${sessionScope.m.memberId }">
				<button class="btn btn-primary sell" type="submit">티켓 상품 조회</button>
			</form>
			<form action="/sellerProduct.kt" method="post">
				<input type="hidden" name="type" value="package">
				<input type="hidden" name="memberNo" value="${sessionScope.m.memberNo }">
				<input type="hidden" name="memberId" value="${sessionScope.m.memberId }">
				<button class="btn btn-primary sell" type="submit" >패키지 상품 조회</button>
			</form>				
		</div>
	</div>
